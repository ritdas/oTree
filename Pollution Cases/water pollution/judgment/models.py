...
class Player(BasePlayer):
    ...
    socimp = models.StringField(label="Environmental Impact", choices=["Strong Positive Impact", "Mild Positive Impact", "No Impact", "Mild Negative Impact", "STrong Negative Impact"])
